...
lib.opentmf_get_driver_list.argtypes = [c_void_p, POINTER(POINTER(c_char_p))]
lib.opentmf_get_driver_list.restype = c_int
lib.opentmf_free_driver_list.argtypes = [c_void_p, POINTER(c_char_p)]
lib.opentmf_free_driver_list.restype = c_int
